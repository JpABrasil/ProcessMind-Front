  ...
  fetch(url, {
    ...
    .then((data) => {
      ...
      data.historico.forEach((message: { role: string; parts: any }) => {
        if (!message || !message.role || !message.parts) return;
